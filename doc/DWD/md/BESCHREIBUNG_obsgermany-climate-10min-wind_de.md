# Zusammenfassung: 10-minütige Stationsmessungen des Windes für Deutschland

**Quelle:** `BESCHREIBUNG_obsgermany-climate-10min-wind_de.pdf`
**Version:** v24.03
**Ausgabedatum:** 2024-03-29
**Datensatz-ID:** `urn:x-wmo:md:de.dwd.cdc::obsgermany-climate-10min-wind`

## Überblick

Der Datensatz enthält 10-minütige Windmessungen der DWD-Stationen sowie rechtlich und qualitativ gleichgestellter Partnernetze. Beim Download werden umfangreiche Stationsmetadaten mitgeliefert (Stationsverlegungen, Instrumentenwechsel, Wechsel der Bezugszeit, Änderungen in den Algorithmen).

- **Zeitliche Abdeckung:** 1989-07-03 bis heute
- **Räumliche Abdeckung:** Deutschland
- **Projektion:** WGS 84 (EPSG:4326)
- **Parameter:** Windrichtung, Windgeschwindigkeit
- **Einheiten:** Grad, m/s
- **Statistische Verarbeitung:** Zeitreihe, 10-Minutenmittel, Standardabweichung
...
Zusätzliche Datei: `historical/zehn_min_ff_Beschreibung_Stationen.txt` mit aktueller geographischer Position und zeitlicher Abdeckung je Station.
...
| `SLA_10` | Standardabweichung der lateralen Windgeschwindigkeit der vorangegangenen 10 Minuten (Fehlwert = -999) | – | `990.0` |
| `SLO_10` | Standardabweichung der longitudinalen Windgeschwindigkeit der vorangegangenen 10 Minuten (Fehlwert = -999) | – | `990.0` |
| `FF_10` | Mittlere Windgeschwindigkeit der vorangegangenen 10 Minuten (Fehlwert = -999) | m/s | `990.0` |
| `DD_10` | Mittlere Windrichtung der vorangegangenen 10 Minuten (Fehlwert = -999) | ° | `990` |
