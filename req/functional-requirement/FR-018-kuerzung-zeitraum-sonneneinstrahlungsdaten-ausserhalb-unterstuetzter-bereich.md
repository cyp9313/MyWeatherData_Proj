# FR-018: Kürzung des Zeitraums bei teilweiser Überschreitung des unterstützten Zeitraums (Sonneneinstrahlungsdaten)
...
## Beschreibung
Wenn der Import der Sonneneinstrahlungsdaten für einen Zeitraum ausgelöst wird, der teilweise außerhalb von 01.01.2015–31.12.2025 liegt, muss der Import-Client nur die Daten innerhalb des unterstützten Zeitraums importieren und der Nutzerin/dem Nutzer einen Hinweis anzeigen, dass der Zeitraum gekürzt wurde.
...
4. Import der Sonneneinstrahlungsdaten für den gekürzten Zeitraum gemäß FR-017 durchführen.
5. Hinweis anzeigen, dass der angefragte Zeitraum gekürzt wurde.

## Ausgabe / Ergebnis
10-Minuten-Strahlungswerte der Station für den gekürzten, unterstützten Zeitraum sowie ein Hinweis auf die Kürzung.
