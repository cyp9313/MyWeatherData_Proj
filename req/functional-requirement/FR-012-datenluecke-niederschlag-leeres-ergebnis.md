...
## Beschreibung
Wenn für einen gültigen Zeitraum keine Niederschlags-Messwerte der Station vorliegen (Datenlücke), muss der Import-Client ein leeres Ergebnis mit einem Hinweis auf die fehlenden Daten zurückgeben, statt einen Fehler zu melden.
